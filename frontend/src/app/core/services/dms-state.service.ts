 ...
 * AdminUserService (GET /admin/users). Also gone (System 11): the
...
export class DmsStateService {
    ...
    switch (r) {
      case 'Judge':
        return {
          ...
          stats: [
            {
              label: 'Cases on docket',
              value: '23',
              delta: '4 listed today',
              deltaType: 'neutral',
              deltaColor: '#426d9b',
            },
            {
              ...
              value: '6',
              delta: 'next 11:30 IST',
              deltaType: 'neutral',
              deltaColor: '#5b6775',
            },
            {
              label: 'Flagged integrity',
              value: '1',
        ...
        return {
          ...
          stats: [
            ...
            },
            {
              ...
              value: '34',
              delta: '5 new documents',
              deltaType: 'up',
              deltaColor: '#2e7d4f',
            },
            {
              label: 'Disclosure deadlines',
              value: '2',
              delta: 'earliest 2 Mar',
              deltaType: 'warn',
              deltaColor: '#b26a00',
            },
            {
      ...
      case 'Forensics':
        return {
          ...
          stats: [
            ...
            {
              label: 'Exhibits in custody',
              value: '19',
              delta: 'all tamper-sealed',
              deltaType: 'up',
              deltaColor: '#2e7d4f',
            },
            {
      ...
      default:
        return {
          ...
          stats: [
            ...
            {
              label: 'Pending redactions',
              value: '3',
              delta: '1 overdue (§228A)',
              deltaType: 'warn',
              deltaColor: '#b26a00',
            },
            {
  ...
  readonly activityFeed = [
    {
      text: 'Forensic_Report_UPI_4521.pdf uploaded',
      meta: 'sha256 d41f9a3c…2d58 · Dr. A. Iyer',
      time: '2h ago',
      dotColor: '#2e7d4f',
    },
    {
      text: 'Adv. S. Bhat viewed Witness_statement_02.pdf',
      meta: 'audit entry #1203 · Disclosure verified',
      time: '4h ago',
      dotColor: '#426d9b',
    },
    {
      text: 'Redacted copy created — Witness_statement_02.pdf',
      meta: 'sha256 a09c73e5…35f6 · §228A compliance',
      time: 'Yesterday',
      dotColor: '#b26a00',
    },
    {
      text: 'Chain integrity verified — 1,204 entries intact',
      meta: 'automated system daemon · ED25519-01',
      time: 'Yesterday',
      dotColor: '#2e7d4f',
    },
    {
      text: 'Access denied — defence counsel, exhibit E-04',
      meta: 'policy enforcement: police-only clearance',
      time: '2 days ago',
      dotColor: '#c53030',
    },
  ];
  ...
  readonly accessFields = [
    ...
    {
      label: 'Witness Protected Identity',
      value: 'Suresh Pillai, 44, Sector 62',
      restricted: true,
    },
    { label: 'Seized Mobile IMEI', value: '35•••••••••••21', restricted: false },
    {
      label: 'Beneficiary Bank Account',
      value: 'HDFC ••••7742 — Kolkata Gariahat branch',
      restricted: false,
    },
    {
      label: 'Investigating Officer Field Diary',
      value: 'Suspect vehicle registration DL-3C-AZ-9912 traced via toll gantry camera',
      restricted: true,
    },
  ];
  ...
  startUpload(file: File, documentType: DocumentType, description: string) {
    ...
    this.documentService
      .upload(caseId, { documentType, description: description || undefined, file })
      .subscribe({
        next: (event) => {
